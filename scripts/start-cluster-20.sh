...
echo "  Nodes: http://127.0.0.1:8081 .. http://127.0.0.1:8100"
echo ""
echo "Write-stress (distribute across all nodes):"
echo "  ./bin/trafficgen -write-stress -write-stress-initial 300 -write-stress-step 150 -write-stress-duration 10s -write-stress-p95-limit 500 -urls 'http://127.0.0.1:8081,...,http://127.0.0.1:8100'"
echo ""
